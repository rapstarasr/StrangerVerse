...
const featureCards = [
  {
    ...
    description: "Step into a private space where curiosity leads the conversation.",
    icon: MessageCircleMore,
  },
  {
    title: "Video calling",
    description: "Jump into crystal-clear conversations across continents in seconds.",
    icon: Video,
  },
  {
    title: "Voice calling",
    description: "Bring warmth and spontaneity to your next connection with audio.",
    icon: Mic,
  },
  {
    title: "Media sharing",
    description: "Share moments, reactions, and memories effortlessly in real time.",
    icon: Sparkles,
  },
  {
    title: "Privacy first",
    description: "Protect your identity with thoughtful defaults and secure flows.",
    icon: ShieldCheck,
  },
  {
    title: "Global matching",
    description: "Meet people from more than 150 countries and countless cultures.",
    icon: Globe2,
  },
];

const processSteps = [
  { title: "Find a stranger", description: "Enter the lounge and let StrangerVerse match you instantly." },
  { title: "Connect instantly", description: "Open a private room with fast, low-latency conversations." },
  { title: "Start talking", description: "Switch between text, voice, and video as the moment unfolds." },
];

const testimonials = [
  {
    quote: "The atmosphere feels cinematic and calm. Every connection feels premium.",
    name: "Mina R.",
    role: "Design Lead",
  },
  {
    quote: "It feels like a global lounge built for curious minds and meaningful moments.",
    name: "Darius T.",
    role: "Product Builder",
  },
  {
    quote: "Everything from the interface to the safety details feels beautifully intentional.",
    name: "Ava S.",
...
const faqs = [
  {
    ...
    answer: "Yes. You can start a conversation without sharing personal details, and you remain in control of how much you reveal.",
  },
  {
    question: "Can I switch between text, voice, and video?",
    answer: "Absolutely. StrangerVerse is built to let you move naturally between modes whenever the moment calls for it.",
  },
  {
    question: "How does safety work?",
    answer: "We pair human-centered design with quick moderation tools so you can focus on the connection, not the friction.",
  },
  {
    question: "Is it available on mobile?",
    answer: "Yes. The experience is tuned for mobile, tablet, and desktop so you can connect from anywhere.",
  },
];
    ...
    <main className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(139,92,246,0.22),_transparent_28%),radial-gradient(circle_at_80%_20%,_rgba(34,211,238,0.16),_transparent_24%),linear-gradient(135deg,_#030712_0%,_#09090f_45%,_#120323_100%)] text-white">
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-slate-950/70 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <button className="hidden rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-300 sm:inline-flex">
              Sign in
            </button>
            <Link
              href="/chat"
      ...
      <section className="mx-auto grid max-w-7xl gap-14 px-4 py-20 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
        ...
        >
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-300 sm:text-xl">
            Meet people instantly through anonymous text, voice, and video conversations designed to feel fast, safe, and unforgettable.
          </p>
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/15 bg-slate-950/70 p-6 shadow-[0_0_90px_rgba(94,234,212,0.16)] backdrop-blur-2xl">
            ...
            <div className="relative grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-cyan-400/20 bg-cyan-400/10 p-5">
                <div className="text-sm text-cyan-200">Live lounge</div>
                <div className="mt-3 text-3xl font-semibold text-white">24k+ online</div>
                <div className="mt-2 text-sm text-slate-300">Across 150 countries in real time</div>
              </div>
              <div className="rounded-2xl border border-fuchsia-400/20 bg-fuchsia-400/10 p-5">
                <div className="text-sm text-fuchsia-200">Intelligence</div>
                <div className="mt-3 text-3xl font-semibold text-white">AI aware</div>
                <div className="mt-2 text-sm text-slate-300">Smart moderation keeps things calm</div>
              </div>
      ...
      <section className="border-y border-white/10 bg-slate-950/40 backdrop-blur">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-10 sm:grid-cols-2 lg:grid-cols-4 sm:px-6 lg:px-8">
          {[
            ...
            { value: 50, suffix: "M+", label: "Conversations" },
            { value: 24, suffix: "/7", label: "Live concierge" },
          ].map((stat) => (
            <div key={stat.label} className="rounded-2xl border border-white/10 bg-white/5 p-5 text-center">
              <div className="text-3xl font-semibold text-white">
                <AnimatedCounter target={stat.value} suffix={stat.suffix} />
              </div>
              <div className="mt-2 text-sm uppercase tracking-[0.28em] text-slate-400">{stat.label}</div>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              ["AI moderation", "Signals and safeguards help keep the space welcoming."],
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <div className="text-sm font-semibold uppercase tracking-[0.32em] text-cyan-300">Testimonials</div>
            <h2 className="mt-4 text-3xl font-semibold text-white sm:text-4xl">Loved by people who value genuine conversation.</h2>
          </div>
        </div>
